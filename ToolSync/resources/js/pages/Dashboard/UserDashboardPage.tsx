                                ...
                                <header className="mb-4 flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-[11px] text-gray-500">
                                            Tools that are due in the next 7 days.
                                        </p>
                                    </div>
                        ...
                        <div className="space-y-6">
                                ...
                                <ol className="space-y-4 text-xs text-gray-700">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[11px] text-gray-500">
                                                You returned &quot;Design Laptop&quot; to the IT
                                                storage.
                                            </p>
                                    ...
                                    <li className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[11px] text-gray-500">
                                                You borrowed &quot;Conference Projector&quot; for
                                                Room A.
                                            </p>
                                            <p className="mt-1 text-[10px] text-gray-400">
                                                9:02 AM
                                    ...
                                    <li className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[11px] text-gray-500">
                                                3 tools were scheduled for quarterly maintenance.
                                            </p>
                                            <p className="mt-1 text-[10px] text-gray-400">
                                                8:30 AM
                                            </p>
                            ...
                            <section className="rounded-3xl bg-white p-6 shadow-sm">
                                ...
                                <div className="grid gap-3 text-xs text-gray-700 sm:grid-cols-2">
                                    ...
                                    >
                                        <span className="mb-1 text-xs font-semibold text-blue-800">
                                            Request tool
                                        </span>
                                        <span className="text-[11px] text-blue-900/80">
                                            Quickly submit a borrowing request to admins.
                                        </span>
                                    </button>
                                    <button
                                        type="button"
                                    ...
                                    >
                                        <span className="mb-1 text-xs font-semibold text-rose-800">
                                            Report issue
                                        </span>
                                        <span className="text-[11px] text-rose-900/80">
                                            Flag damaged or missing tools for review.
                                        </span>
                                    </button>
                                </div>
                            </section>
